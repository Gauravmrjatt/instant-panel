...
const Header = () => {
    ...
    return (
        <>        <nav
            ...
            id="layout-navbar"
        >
            <div id='menuDEk' className="layout-menu-toggle navbar-nav align-items-xl-center me-3 me-xl-0 d-xl-none">
                    ...
                    <li className="nav-item navbar-dropdown dropdown-user dropdown">
                        <a className="nav-link dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                            <div className="avatar avatar-online">
                                ...
                                <User src={userPic} className="w-px-40 h-auto rounded-circle" />
                            </div>
                        </a>
                        <ul className="dropdown-menu dropdown-menu-end">
                            ...
                            <li>
                                <Link className="dropdown-item" href="/dashobard/billing">
                            ...
                            <li>
                                <a className="dropdown-item" onClick={() => router.push("/logout/" + userData.loginToken)}>
            ...
            <div ref={search} className='searchBartop' style={{ boxShadow: "0px 2px 50px -20px" }} >
                <IconButton css={{ marginLeft: "auto", marginRight: "10px" }} onClick={() => search.current.style.display = 'none'}>
                    close
                </IconButton>
                {searches.map(item => (
                    <div style={{ padding: "10px", display: "flex", justifyContent: "space-between", alignItems: "center", }} key={item._id}>{item.name}

                        <span style={{ display: "flex" }}>
                            <IconButton style={{ padding: "10px" }} onClick={() => router.push("/dashboard/camp/view/" + item._id)}>
                                <EyeIcon size={20} fill="#979797" />
                            </IconButton>
                            <IconButton style={{ padding: "10px" }} onClick={() => router.push("/dashboard/camp/edit/" + item._id)}>
