...
import { TimeCircle, ShieldDone, PaperPlus, Paper, Chart, Activity, Setting, People, Send, Filter, Work, MoreCircle, Upload, User, Search, Discount, Show } from 'react-iconly'
const MyNav = () => {
    const router = useRouter();
    const isActive = route => {
        return (router.asPath === route || router.asPath === route) ? `menu-item active` : `layout-menu-toggle menu-item`
    }
    return (
        <>
            <div>
                <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
                    <div className="app-brand demo">
                        <Link href="/dashboard" className="app-brand-link">
                            ...
                            <span className="app-brand-text demo menu-text fw-bolder ms-2">{myDetails.name}</span>
                        </Link>
                    ...
                    <ul className="menu-inner py-1">
                        <li className={isActive("/dashboard")}>
                            <Link href="/dashboard" className="menu-link">
                                <Work set="bulk" className="menu-icon" primaryColor="blueviolet" />
                        ...
                        <li className="menu-item">
                            <a className="menu-link menu-toggle">
                                <MoreCircle set="bulk" className="menu-icon" primaryColor="blueviolet" />
                                <div data-i18n="Layouts">More</div>
                            </a>

                            <ul className="menu-sub">
                                <li className="menu-item">
                                    <Link href="https://earningarea.in/Create" className="menu-link">
                                        <div data-i18n="Without menu">Create Lifafa</div>
                                    </Link>
                                </li>
                                <li className="menu-item">
                                    <Link href="https://earningarea.in/Create-Scratch" className="menu-link">
                                        <div data-i18n="Without navbar">Create Scratch Card</div>
                                    </Link>
                                </li>
                                <li className="menu-item">
                                    <Link href="https://earningarea.in/bulk" className="menu-link">
                                        <div data-i18n="Container">Bulk Payments</div>
                                    </Link>
                                </li>
                                <li className="menu-item">
                                    <Link href="https://earningarea.in/Youtube/index.php" className="menu-link">
                        ...
                        <li className={isActive("/dashboard/campaigns")}>
                            <Link href="/dashboard/campaigns" className="menu-link">
                                <PaperPlus className="menu-icon" set="bulk" primaryColor="blueviolet" />
                        ...
                        <li className={isActive("/dashboard/liveCampaigns")}>
                            <Link href="/dashboard/liveCampaigns" className="menu-link">
                                ...
                                <Paper className="menu-icon" set="bulk" primaryColor="blueviolet" />
                        ...
                        <li className={isActive("/dashboard/reports")}>
                            <Link href="/dashboard/reports" className="menu-link">
                                {/* <i className="menu-icon tf-icons bx bxs-crown"></i> */}
                                <Chart className="menu-icon" set="bulk" primaryColor="blueviolet" />
                        ...
                        <li className={isActive("/dashboard/clicks")}>
                            <Link href="/dashboard/clicks" className="menu-link">
                                {/* <i className="menu-icon tf-icons bx bxs-crown"></i> */}
                                <Search className="menu-icon" set="bulk" primaryColor="blueviolet" />
                        ...
                        <li className={isActive("/dashboard/postBack")}>
                            <Link href="/dashboard/postBack" className="menu-link">
                                <Activity className="menu-icon" set="bulk" secondaryColor='blueviolet' primaryColor="blueviolet" />
                        ...
                        <li className={isActive("/dashboard/pay-to-user")}>
                            <Link href="/dashboard/pay-to-user" className="menu-link">
                                <User className="menu-icon" set="bulk" primaryColor="blueviolet" />
                        ...
                        <li className={isActive("/dashboard/clickPay")}>
                            <Link href="/dashboard/clickPay" className="menu-link">
                                <People className="menu-icon" set="bulk" primaryColor="blueviolet" />
                        ...
                        <li className={isActive("/dashboard/geteway-settings")}>
                            <Link href="/dashboard/geteway-settings" className="menu-link">
                                <Setting className="menu-icon" set="bulk" primaryColor="blueviolet" />
                                <div data-i18n="Basic">Gateway Settings</div>
                            </Link>
                        </li>
                        <li className={isActive("/dashboard/getGateway")}>
                            <Link href="https://earningarea.in/Withdraw-api.php" className="menu-link">
                                <Upload set="bulk" className="menu-icon" primaryColor="blueviolet" />
                        ...
                        <li className={isActive("/dashboard/pending")}>
                            <Link href="/dashboard/pending" className="menu-link">
                                <TimeCircle className="menu-icon" set="bulk" secondaryColor='blueviolet' primaryColor="blueviolet" />
                        ...
                        <li className={isActive("/dashboard/api/checkRefer")}>
                            <Link href="/dashboard/api/checkRefer" className="menu-link">
                                <ShieldDone className="menu-icon" set="bulk" secondaryColor='blueviolet' primaryColor="blueviolet" />
                        ...
                        <li className={isActive("/dashboard/customAmount")}>
                            <Link href="/dashboard/customAmount" className="menu-link">
                                <Discount className="menu-icon" set="bulk" secondaryColor='blueviolet' primaryColor="blueviolet" />
                        ...
                        <li className={isActive("/dashboard/viewCustom")}>
                            <Link href="/dashboard/viewCustom" className="menu-link">
                                <Show className="menu-icon" set="bulk" secondaryColor='blueviolet' primaryColor="blueviolet" />
                                <div data-i18n="Campaigns">View Custom Amount</div>
                            </Link>
                        </li>

                        <li className="menu-header small text-uppercase"><span className="menu-header-text">Security &amp; Alerts</span></li>
                        <li className={isActive("/dashboard/ban-number")}>
                            <Link className="menu-link" href='/dashboard/ban-number'>
                                <Filter className="menu-icon" set="bulk" primaryColor="blueviolet" />
                                <div data-i18n="Form Elements">Ban Numbers</div>
                            </Link>
                        </li>

                        <li className={isActive("/dashboard/telegram-alerts")}>
                            <Link href="/dashboard/telegram-alerts" className="menu-link">
                                <Send className="menu-icon" set="bulk" primaryColor="blueviolet" />
                        ...
                        <li className="menu-item">
                            <Link
                                ...
                                className="menu-link"
                            >
                                <Send className="menu-icon" set="bold" primaryColor="blueviolet" />
                        ...
                        <li className="menu-item">
                            <Link
                                ...
                                className="menu-link"
                            >
                                <User set="bold" className="menu-icon" primaryColor="blueviolet" />
