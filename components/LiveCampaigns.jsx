        ...
        <>
            ...
            >
                <Table.Header>
                    ...
                    <Table.Column key="events" css={{ textAlign: "center" }} allowsSorting>
                        EVENTS
                    </Table.Column>
                    <Table.Column css={{ textAlign: "center" }} key="action" allowsSorting>
                        ACTIONS
                    </Table.Column>
                </Table.Header>
                <Table.Body items={list.items} loadingState={list.loadingState}>
                    {(item) => (
                        <Table.Row onClick={() => router.push("hi")} key={item._id}>
                            <Table.Cell> <User squared src='' name={item.name} css={{ p: 0 }}>
                                {item.offerID}
                            </User></Table.Cell>
                                ...
                                <Row justify="center" align="center">
                                    <Col css={{ d: "flex" }}>
                                        <Tooltip content="Details">
                                            <IconButton onClick={() => router.push("camp/view/" + item._id)}>
                                    ...
                                    <Col css={{ d: "flex" }}>
                                        <Tooltip content="Edit">
                                            <IconButton onClick={() => router.push("camp/edit/" + item._id)}>
                                    ...
                                    <Col css={{ d: "flex" }}>
                                        <Tooltip
                                            ...
                                            color="error"
                                            onClick={() => handleClick()}
                                            onDoubleClick={() => { deleteItem(item._id, list.load); handleClose() }}
                                        >
                                            <IconButton>
