...
router.use('/update/postback', require("../routes/api/postback/updatePostBackKey"))

router.use('/get/gateway-settings', require("../routes/api/gateway-settings/getGatewaySettings"))
router.use('/update/gateway-settings', require("../routes/api/gateway-settings/updateGateway-settings"))

router.use('/get/telegram-alert', require("../routes/api/telegram-alert/getTelegram-alert"))
router.use('/update/telegram-alert', require("../routes/api/telegram-alert/updateTelegramalert"))
...
router.use('/update/campaign', require("../routes/api/campaign/updateCampaign"))
router.use('/delete/campaign', require("../routes/api/campaign/deleteCampaign"))
...
router.use("/api/update/pendings", require("../routes/api/pendingPayments/updatePending"))

//dashboard
router.use('/get/dashboard', require("../routes/api/dashboard/getDashboardData"))
