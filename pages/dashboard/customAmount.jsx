...
export default function CustomAmount() {
    ...
    const addCustom = () => {
        return new Promise((resolve, reject) => {
            axios.post('/api/v1/custom', { ...customDetails })
                .then((response) => {
                        ...
                        <div className="content-wrapper">
                            <div className="container-xxl flex-grow-1 container-p-y">
                                <h4 className="fw-bold py-3 mb-4">
                                    <span className="text-muted fw-light">Dashboard /</span> Custom Amount
                                </h4>
                                <div className="row">
                                                    ...
                                                    <div style={{ marginTop: "50px" }} className="row">
                                                        ...
                                                        <div className="mb-3 col-md-6">
                                                            ...
                                                            <Input
                                                                ...
                                                                contentLeft={<i class='bx bxs-comment-edit'></i>}
                                                            />
                                                        </div>
                                                    </div>
                                                    <div className="mt-2">
                                                        <button onClick={submitCustom} className="btn btn-primary me-2">
                                                            Add
                                                        </button>
                                                    </div>
                                                </form>
