    ...
    // Valid request 
        {
            ...
            "count" : 20, // number of total refers 
            "clicks" : 20, // number of total clicks 
            "data": [
                {
                    "user" : 9876543210, // refer to
                    "refer" : 9876543210,  // your number
                    "userAmount" : 10,  // user amount
                    "referAmount" : 10,  // refer amount
                    "referAmount" : 10,  // refer amount
                    "event" : "event" // event name
                    "status" : "APPROVE || PENDING || REJECTED" // lead status
                    "click": "click id"
                    "paymentStatus" : "Payment statue" // Status of payment
                    "payMessage":"Payment Message" 
                    "createdAt" : "date" // In Date formate
                }
            ] // returning all refers as a array 
        }
...
`;
export default function ReferApi() {
    ...
    useEffect(() => {
        ...
        async function getKey() {
            ...
            const newUrl = replaceAllPlaceholders(data.data.url, {
                "/api/v1/postback/": "/api/v1/checkRefer/",
                "{eventname}?": "{offerid}?number={number}",
                "click={click_id}": "",
                    ...
                    <div className="layout-page">
                        ...
                        <div className="content-wrapper">
                            <div className="container-xxl flex-grow-1 container-p-y">
                                <h4 className="fw-bold py-3 mb-4"><Link href='/dashboard' className="text-muted fw-light">Dashboard / Api /</Link>  Check Refer</h4>

                                <div className="row">
                                    <div className="col-md-12">

                                        <div className="card mb-4">
                                            <h5 className="card-header">Refer Check Api</h5>
                                                ...
                                                <form id="formAccountSettings" >
                                                    <div className="row">
                                                        <div className="mb-3 col-md-6">
                                                            <label htmlFor="postback-url" className="form-label">Api</label>
                                                        ...
                                                        <div className="mb-3 col-md-6">
                                                            <label htmlFor="postback-key" className="form-label">Api Key</label>
                                        ...
                                        <div className="card mb-5">
                                            ...
                                            <div style={{ background: "#302c34", borderRadius: "10px", paddingTop: "15px" }} className="card-body">
                                                <div style={{ background: "#302c34", borderRadius: "10px" }} className="mb-3 col-12 mb-0">
                                            ...
                                            <div className="card-body">
                                                <div className="mb-3 col-12 mb-0">
                                                    <div className="alert alert-warning">
                                                        <h6 className="alert-heading fw-bold mb-1">I want to change my api key?</h6>
                                                        <p className="mb-0">Your PostBack key is your Api key please change your postback key to change api key</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
