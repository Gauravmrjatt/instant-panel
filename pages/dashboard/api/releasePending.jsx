...
{
  "number": "", // user number or upi
  "comment" : "", // comment for the transaction
  "approve_type" : "approve" // approve or reject
}
...
export default function UserApi() {
  ...
  useEffect(() => {
    ...
    async function getKey() {
      ...
      const newUrl = replaceAllPlaceholders(data.data.url, {
        "/api/v1/postback/": "/api/v1/releasePending/",
        "{eventname}?": "{offerid}",
        "click={click_id}": "",
  ...
  return (
    <>
      <Head>
        <title>Release Pending api</title>
      </Head>
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="card mb-4">
                      <h5 className="card-header">Release Pending Api</h5>
