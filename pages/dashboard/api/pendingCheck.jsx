    ...
    // Valid request 
        {
            ...
            "totalUserAmount" : 20, // number of total clicks 
            "data": [
                {
                    "cliclId": "click id", (ObjectId)
                    "event" : "event" // event name
                    "createdAt" : "date" // In Date formate
                }
            ] // returning all pending as a array 
        }
...
`;
export default function CheckPendingApi() {
  ...
  useEffect(() => {
    ...
    async function getKey() {
      ...
      const newUrl = replaceAllPlaceholders(data.data.url, {
        "/api/v1/postback/": "/api/v1/checkPending/",
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="card mb-4">
                      <h5 className="card-header">Check Pending Api</h5>
