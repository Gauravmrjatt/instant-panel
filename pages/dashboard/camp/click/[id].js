  ...
  const handelLeadStatus = async () => {
    toast.promise(
      new Promise((resolve, reject) => {
        axios
          .post("/update/leadStatus", { leadStatus, ID })
          .then((response) => {
                  ...
                  <div className="col-md-12">
                    <div className="card mb-4">
                      ...
                      >
                        {isLoading ? (
                          <Skeleton
                            sx={{ maxWidth: "300px", fontSize: "1.125rem" }}
                          />
                        ) : (
                          "Lead Details"
                        )}
                        ...
                        <List
                          ...
                          subheader={
                            isLoading ? (
                              ...
                              <ListSubheader>Click Id</ListSubheader>
                            )
                          }
                        >
                          {isLoading ? (
                            <Skeleton
                              sx={{ fontSize: "3.125rem", marginLeft: "10px" }}
                            />
                          ) : (
                            <>
                              <ListItem
                              ...
                              >
                                <ListItemText
                                  ...
                                  primary={details?.leadData?.clickId.click}
                                />
                                <IconButton
                                  onClick={() =>
                                    copyId(details?.leadData?.clickId.click)
                                  }
                                  aria-label="delete"
                                >
                        ...
                        <List
                          ...
                          subheader={
                            isLoading ? (
                              ...
                              <ListSubheader>Lead Status</ListSubheader>
                            )
                          }
                        >
                          {isLoading ? (
                            ...
                            <>
                              ...
                              >
                                <ListItemText
                                  ...
                                  primary={details?.leadData?.message}
                                />
                              ...
                              <>
                                ...
                                >
                                  <ListItemText
                                    ...
                                    primary={details?.leadData?.payMessage}
                                  />
                                  <Badge
                                    enableShadow
                                    disableOutline
                                    color={getPaymnetCard(
                                ...
                                <ListItem
                                  sx={{
                                    ...
                                    background: "#F31260",
                                    color: "white",
                                    boxShadow: "0 4px 14px 0 #f3126099",
                                  }}
                                >
                                  <ListItemText
                                    sx={{
                            ...
                            >
                              ...
                              {isLoading ? (
                                ...
                                >
                                  ...
                                  >
                                    {toDateTime(
                                      details?.leadData?.clickId.createdAt
                                    )}
                                  </Badge>
                                </ListItem>
                              )}
                            ...
                            <List
                              ...
                              subheader={
                                isLoading ? (
                                  ...
                                  <ListSubheader>Params</ListSubheader>
                                )
                              }
                            >
                              {isLoading ? (
                                ...
                                Object.entries(
                                  details?.leadData.clickId.params
                                ).map(([key, value]) => (
                                  <ListItem
                                    sx={{
                                      background: "#e7eaef00",
                              ...
                              {isLoading ? (
                                ...
                                <>
                                  ...
                                  >
                                    ...
                                    >
                                      {
                                        details?.leadData.clickId.device?.os
                                          ?.name
                                      }
                                    </Badge>
                                  </ListItem>
                                  ...
                                  >
                                    ...
                                    >
                                      {
                                        details?.leadData.clickId.device?.client
                                          ?.name
                                      }
                                    </Badge>
                                  </ListItem>
                                  ...
                                  >
                                    ...
                                    >
                                      {
                                        details?.leadData.clickId.device?.device
                                          ?.type
                                      }
                                    </Badge>
                                  </ListItem>
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      <AccordionDetails>
                                        <pre>
                                          {showJson(
                                            details?.leadData.clickId.device
                                          )}
                                        </pre>
                                      </AccordionDetails>
                                    </Accordion>
