                    ...
                    <div className="layout-page">
                        ...
                        <div className="content-wrapper">
                            <div className="container-xxl flex-grow-1 container-p-y">
                                ...
                                <Button onPress={() => router.push("/dashboard/liveCampaigns")} rounded icon={<i className='bx bx-list-ol'></i>} color='secondary' css={{ display: "block", marginLeft: "auto", marginBottom: "20px" }}>Live Campaigns</Button>
                                <div className="row">
                                    <div className="col-md-12">
                                        <div className="card mb-4">
                                            <h5 className="card-header">Edit Campaign  <Switch checked={switchs.campStatus} onChange={(e) => { handelSwith(e, "campStatus"); handelOnOff(e) }} color='success' shadow iconOn={<ShieldDone set="bold" primaryColor="#17c964" />} iconOff={<Lock set="bold" primaryColor="red" />} css={{ position: "absolute", right: "20px", top: '20px' }} /></h5>
                                            <hr className="my-0" />
                                            {isLoading ? (
                                                <>
                                            ...
                                            <div className="card-body">
                                                <Paper variant="outlined" sx={{ padding: "10px", marginBottom: "20px" }} >
                                                ...
                                                <div>
                                                    <Button2 onClick={() => router.push("/info/how-to-use")} sx={{ marginBottom: "20px", marginLeft: "auto", display: "block" }}>How to use?</Button2>
                                                </div>
                                                <div className="row">
                                                    {isLoading ? (
                                                        <>
                                                            <Backdrop
                                                                sx={{ color: '#fff', zIndex: 1, position: 'absolute', background: 'rgb(255 255 255 / 50%)', top: "70px" }}
                                                                open={true}
                                                            >
                                                ...
                                                <hr />
                                                <Button2 onClick={() => router.push("/dashboard/pending/" + ID)} sx={{ marginBottom: "20px", marginLeft: "auto", display: "block" }}>Pending Payments?</Button2>
                                                ...
                                                <hr />
                                                <div className="mt-2">
                                                    <button style={{ float: "right" }} onClick={() => AddNewCamp()} className="btn btn-primary me-2">Save Updates</button>
                                                </div>
                                            </div>
                                        </div>
