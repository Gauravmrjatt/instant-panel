...
export default function Leads() {
    ...
    const columns = [
        ...
        {
            field: 'message', headerName: 'MSG', width: 70,
            renderCell: (params) => {
                const { value } = params;
                let chipColor = 'primary';
                let chipLabel = value;
        ...
        {
            field: 'payMessage', headerName: 'PAY', width: 70,
            renderCell: (params) => {
                const { value } = params;
                let chipColor = 'primary';
                let chipLabel = value;
        ...
        },
        {
            ...
            renderCell: (params) => (
                <div style={{ textAlign: 'center', justifyContent: "center", width: "100%" }}>
                    <IconButton
                        color="primary"
                        onClick={() => router.push("/dashboard/camp/click/" + params.row.id + "?event=" + params.row.event)} // Replace with your action function
                    >
                        <i style={{ display: "block", marginInline: "auto" }} className='bx bx-dots-vertical-rounded'></i>
                    </IconButton>
                </div>
            ),
        },
