                    ...
                    <div className="layout-page">
                        ...
                        <div className="content-wrapper">
                            <div className="container-xxl flex-grow-1 container-p-y">
                                <h4 className="fw-bold py-3 mb-4"><span className="text-muted fw-light">Dashboard /</span> Ban Number</h4>
                                <div className="row">
                                    <div className="col-xl">
                                        <div className="card mb-5">
                                            <h5 className="card-header">Ban Number</h5>
                                            <hr className="my-0" />
                                                ...
                                                <div style={{ maxWidth: "500px", marginInline: "auto" }} className="mb-4">
                                                    ...
                                                    <div className="card-body">
                                                        <div className="form-floating">
                                                            <input type='number' onChange={handleNumberdChange} value={number} className="form-control" id="floatingInput" placeholder="https://earningarea.in" aria-describedby="floatingInputHelp" fdprocessedid="badxh9" />
                                                            <label htmlFor="floatingInput">Number</label>
                                                            <div id="floatingInputHelp" className="form-text">
                                                                Enter a 10 digits number to ban
                                                            </div>
                                                        </div>
                                        ...
                                        <div className="card mb-4">
                                            ...
                                            <div className="card-body">
                                                <ul>
                                                    ...
                                                    <li>
                                                        enter number will not be able to get payment
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
